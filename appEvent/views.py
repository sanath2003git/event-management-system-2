...
def about_us(request):
    ...
    values = [

        {
            ...
            "desc": "We prioritize building strong relationships with our users and partners"
        },

        {
            "icon": "fas fa-lightbulb",
            "title": "Innovation",
            "desc": "We constantly evolve to meet the changing needs of event organizers"
        },

        {
            "icon": "fas fa-shield-alt",
            "title": "Trust & Security",
            "desc": "We ensure the highest standards of data protection and reliability"
        },
...
def manage_bookings(request):
    ...
    if request.method == "POST":
        ...
        if action == "confirm":
            ...
            messages.success(
                request,
                f"Booking for {booking.event.title} has been confirmed."
            )
            ...
            messages.warning(
                request,
                f"Booking for {booking.event.title} has been cancelled."
            )
...
def forgotpassword(request):
    ...
    if request.method == "POST":
        ...
        messages.success(
            request,
            f"If an account with {email} exists, a reset link has been sent."
        )
